...
universidad = Universidad("Universidad Ejemplo", carreras)

universidad.imprimir_carreras()

print()

carrera1.imprimir_datos()
carrera2.imprimir_datos()
carrera3.imprimir_datos()